...
function newTicket(){
    ...
    option4.value = 'Mech';
    option2.value = 'EEE';
    option.innerHTML = 'CSE';
    option1.innerHTML = 'ECE';
    option3.innerHTML = 'Civil';
    option4.innerHTML = 'Mech';
    option2.innerHTML = 'EEE';
    ...
    labelPhone.innerHTML = 'Student Name';
    ...
    labelCustomer.innerHTML ='Register Number';
